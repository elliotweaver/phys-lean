...
-- N393 — arc-J J3: KÄHLER COMPATIBILITY ⇒ THE BORN RULE (the capstone).
#print axioms Phys.Quantum.kahlerForm_apply
#print axioms Phys.Quantum.bornForm_foldComplex_invariant
#print axioms Phys.Quantum.foldComplex_skew_adjoint
#print axioms Phys.Quantum.kahlerForm_antisymm
#print axioms Phys.Quantum.kahlerForm_self
#print axioms Phys.Quantum.toDbl_foldComplex
#print axioms Phys.Quantum.hInner_re
#print axioms Phys.Quantum.hInner_im
#print axioms Phys.Quantum.hInner_conj_symm
#print axioms Phys.Quantum.bornProb_eq_dblNormSq
#print axioms Phys.Quantum.bornProb_eq_self_overlap_of_amplitude
#print axioms Phys.Quantum.bornProb_nonneg
#print axioms Phys.Quantum.bornProb_self
#print axioms Phys.Quantum.bornProb_eInward_self
#print axioms Phys.Quantum.bornProb_eInward_eOutward
#print axioms Phys.Quantum.bornProb_eq_mul_normSq
#print axioms Phys.Quantum.born_rule_derived
-- N394 — arc-J J4: MEASUREMENT = THE GATHER.
...
-- N397 — arc-K K1: unitarity from monad idempotency (probability conserved under evolution).
#print axioms Phys.Quantum.dblNormSq_mul
#print axioms Phys.Quantum.toDbl_fromDbl
#print axioms Phys.Quantum.fromDbl_toDbl
#print axioms Phys.Quantum.bornForm_fromDbl
#print axioms Phys.Quantum.evolve_is_sheaf
#print axioms Phys.Quantum.bornForm_evolve
#print axioms Phys.Quantum.unit_phase_preserves_dblNormSq
#print axioms Phys.Quantum.norm_preserving_iff_unit_phase
#print axioms Phys.Quantum.unitary_conserves_born
#print axioms Phys.Quantum.unitary_conserves_gather_resolution
#print axioms Phys.Quantum.J_is_unit_phase
#print axioms Phys.Quantum.unit_phase_group_closed
#print axioms Phys.Quantum.U_mul_dblConj
#print axioms Phys.Quantum.unit_phase_inverse
#print axioms Phys.Quantum.evolve_J_eInward
...
-- N414 — SELF-REFERENCE IS THE GROUND: the generativity witness (arc-N N4).
#print axioms Phys.Algebra.foldRoot_seed
#print axioms Phys.Algebra.foldRoot_squares_to_lookback
#print axioms Phys.Algebra.foldRoot_selfOpposed_of_torsionFree
#print axioms Phys.Algebra.foldRoot_selfBlind_and_selfOpposed_share_seed
#print axioms Phys.Algebra.obstruction_witness_iff_foldRoot_selfOpposed
#print axioms Phys.Algebra.foldRoot_selfOpposed_forces_locus
#print axioms Phys.Algebra.foldRoot_selfOpposed_forces_all_four
...
#print axioms Phys.Algebra.DischargeArcM.absScaleChainR_restrict
#print axioms Phys.Algebra.DischargeArcM.absScaleChainDerived_factors
#print axioms Phys.Algebra.DischargeArcM.absScaleChainDerived_eq_anchor_mul
#print axioms Phys.Algebra.DischargeArcM.phaseSlot_is_banked_amplitude
#print axioms Phys.Algebra.DischargeArcM.lightSlot_is_descent_cosine
#print axioms Phys.Algebra.DischargeArcM.leptonLink_at_winding_boundary
#print axioms Phys.Algebra.DischargeArcM.survival_cast_pos
#print axioms Phys.Algebra.DischargeArcM.survival_cast_lt_one
#print axioms Phys.Algebra.DischargeArcM.absScaleChainDerived_pos
#print axioms Phys.Algebra.DischargeArcM.absScaleChainDerived_lt_anchor
#print axioms Phys.Algebra.DischargeArcM.absScaleChainDerived_lt_one
#print axioms Phys.Algebra.DischargeArcM.absScaleChainDerived_ne_zero
#print axioms Phys.Algebra.DischargeArcM.absScaleChainDerived_ne_anchor
#print axioms Phys.Algebra.DischargeArcM.absolutes_derived

-- N418 — arc-O O3: THE TWO-SECTOR CKM COMPLETION at the DERIVED (non-maximal) fold phase.
#print axioms Phys.Algebra.CKMTwoSectorPhase.phaseEl_re
#print axioms Phys.Algebra.CKMTwoSectorPhase.phaseEl_im
#print axioms Phys.Algebra.CKMTwoSectorPhase.phaseEl_normSq
#print axioms Phys.Algebra.CKMTwoSectorPhase.twoP_eq_quarter
#print axioms Phys.Algebra.CKMTwoSectorPhase.cpFactorDerived_eq_half
#print axioms Phys.Algebra.CKMTwoSectorPhase.cpBalance
#print axioms Phys.Algebra.CKMTwoSectorPhase.cpFactor_between
#print axioms Phys.Algebra.CKMTwoSectorPhase.jarlskogSqCorrected_eq_half
#print axioms Phys.Algebra.CKMTwoSectorPhase.jarlskogSqCorrected_pos
#print axioms Phys.Algebra.CKMTwoSectorPhase.jarlskogSqCorrected_lt
#print axioms Phys.Algebra.CKMTwoSectorPhase.jarlskogSqCorrected_lo
#print axioms Phys.Algebra.CKMTwoSectorPhase.jarlskogSqCorrected_hi
#print axioms Phys.Algebra.CKMTwoSectorPhase.jarlskogCorrected_lo
#print axioms Phys.Algebra.CKMTwoSectorPhase.jarlskogCorrected_hi
#print axioms Phys.Algebra.CKMTwoSectorPhase.jarlskogCorrected_pos
#print axioms Phys.Algebra.CKMTwoSectorPhase.jarlskogCorrected_lt
#print axioms Phys.Algebra.CKMTwoSectorPhase.two_sector_overlap_unitary
#print axioms Phys.Algebra.CKMTwoSectorPhase.two_sector_mixing_normalized
#print axioms Phys.Algebra.CKMTwoSectorPhase.two_sector_corner_zero
...
-- ===== N422 (arc-O O7): the equivalence principle + the Noether correspondence =====
...
-- N### — R7 (arc-R): THE ARITY SIGNATURE (pairs glue, triples tear — the grain of the gluing obstruction).
#print axioms Phys.Algebra.assoc_add_right'
#print axioms Phys.Algebra.assoc_smul_right'
#print axioms Phys.Algebra.assoc_zero_left
#print axioms Phys.Algebra.assoc_zero_mid
#print axioms Phys.Algebra.assoc_zero_right
#print axioms Phys.Algebra.assoc_span2_vanishes
#print axioms Phys.Algebra.obash_ab
#print axioms Phys.Algebra.asw12
#print axioms Phys.Algebra.asw23
#print axioms Phys.Algebra.p_b_a_ab
#print axioms Phys.Algebra.p_a_ab_b
#print axioms Phys.Algebra.p_b_ab_a
#print axioms Phys.Algebra.p_ab_a_b
#print axioms Phys.Algebra.p_ab_b_a
#print axioms Phys.Algebra.assoc_gen_triple
#print axioms Phys.Algebra.assoc_slot1_span
#print axioms Phys.Algebra.assoc_slot2_span
#print axioms Phys.Algebra.assoc_slot3_span
...
#print axioms Phys.Algebra.BandEdgeList.octEdgeScale_pos
#print axioms Phys.Algebra.BandEdgeList.ewEdgeScale_pos
#print axioms Phys.Algebra.BandEdgeList.confEdgeScale_pos
#print axioms Phys.Algebra.BandEdgeList.edges_ordered
#print axioms Phys.Algebra.BandEdgeList.topBand_ratio_from_edges
#print axioms Phys.Algebra.BandEdgeList.confBand_ratio_from_edges
#print axioms Phys.Algebra.BandEdgeList.confBandRatio_eq
#print axioms Phys.Algebra.BandEdgeList.confBandRatio_gt_one
#print axioms Phys.Algebra.BandEdgeList.bandScreen_conf_exact
#print axioms Phys.Algebra.BandEdgeList.derivedBandList_assembly
#print axioms Phys.Algebra.BandEdgeList.invAlphaConf_is_assembly
#print axioms Phys.Algebra.BandEdgeList.ewWaypoint_free
#print axioms Phys.Algebra.BandEdgeList.confWaypoint_free
#print axioms Phys.Algebra.BandEdgeList.bandScreen_neg_depth
#print axioms Phys.Algebra.BandEdgeList.topBand_sense_positive
#print axioms Phys.Algebra.BandEdgeList.topBand_sense_negative
#print axioms Phys.Algebra.BandEdgeList.confBand_sense_positive
#print axioms Phys.Algebra.BandEdgeList.hadronic_band_spectrum
#print axioms Phys.Algebra.BandEdgeList.hadronic_band_floor
#print axioms Phys.Algebra.BandEdgeList.hadronic_plateaus_derived
#print axioms Phys.Algebra.BandEdgeList.leptonEdges_from_ew
#print axioms Phys.Algebra.BandEdgeList.leptonEdges_ordered
#print axioms Phys.Algebra.BandEdgeList.confBand_screen_ne_wrong
#print axioms Phys.Algebra.BandEdgeList.invAlphaConf_gt_ceiling
...
-- N470 — ARC-D D1 THE BRACKET INSTRUMENT (docs/SEED_DIGITS.md §D1)
...
-- D5-next — ARC-D THE DIGITS: THE NARROWING CAMPAIGN, NODE 2 — TIGHTEN EVERY BRACKET
--   (Phys/Algebra/NarrowedBracket.lean). The D5 cos instrument aimed at split@4/@3 (tighter 1/cutPi)
--   + the D1 exp instrument at partial-sum index 10/14 (tighter cutLog, the dominant width factor)
--   + the D4 pipeline re-composed to a strictly narrower certified two-sided rational bracket of the
--   derived 1/α(0) at the derived census.
#print axioms Phys.Foundation.ContinuumQ.partialCos_four
#print axioms Phys.Foundation.ContinuumQ.cutCos_eight_fifths_neg
#print axioms Phys.Foundation.ContinuumQ.cutCos_pos_of_lt_three_halves
#print axioms Phys.Foundation.ContinuumQ.leastCosZero_le_eight_fifths
#print axioms Phys.Foundation.ContinuumQ.three_halves_le_leastCosZero
#print axioms Phys.Foundation.ContinuumQ.cutPi_bracket_tight
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_bracket_tight
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_bracket_tight_strict
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_tight_nested
#print axioms Phys.Algebra.NarrowedBracket.cutLog_content_lo_tight
#print axioms Phys.Algebra.NarrowedBracket.cutLog_content_hi_tight
#print axioms Phys.Algebra.NarrowedBracket.cutLog_content_tight_strict
#print axioms Phys.Algebra.NarrowedBracket.cutLog_content_tight_nested
#print axioms Phys.Algebra.NarrowedBracket.invAlphaZero_narrowed_bracket
#print axioms Phys.Algebra.NarrowedBracket.dressed_narrowed_bracket
#print axioms Phys.Algebra.NarrowedBracket.invAlphaZero_narrowed_strict
#print axioms Phys.Algebra.NarrowedBracket.invAlphaZero_narrowed_width_lt
...
-- D5-next-3 — ARC-D THE DIGITS: THE NARROWING CAMPAIGN, NODE 4 — SHARPEN THE m01 FLOOR AND AIM THE
--   COS INSTRUMENT AT split@5 (Phys/Algebra/NarrowedBracket3.lean). BOTH residual fronts the parent
--   named attacked: (1) the m01 flavor floor SHARPENED via the DIRECT Born-square quotient bracket
--   mass0/mass1 ∈ [17374/5,17396/5] (≈4.6× tighter than the massRatio detour) → cutLog ∈
--   [8153/1000,8155/1000]; (2) 1/cutPi SQUEEZED via split@5 (lower positivity) / split@4 (upper sign)
--   → 1/cutPi ∈ [5000/15709,5000/15707] (≈4×10⁻⁵). Re-composed the D4 pipeline to a strictly narrower
--   (≈26×) certified two-sided rational bracket of the derived 1/α(0) at the derived census.
#print axioms Phys.Foundation.ContinuumQ.partialCos_five
#print axioms Phys.Foundation.ContinuumQ.cutCos_15709_neg
#print axioms Phys.Foundation.ContinuumQ.cutCos_pos_of_lt_15707
#print axioms Phys.Foundation.ContinuumQ.leastCosZero_le_15709
#print axioms Phys.Foundation.ContinuumQ.le_leastCosZero_15707
#print axioms Phys.Foundation.ContinuumQ.cutPi_bracket_split5
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_bracket_split5
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_split5_strict
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_split5_nested
#print axioms Phys.Algebra.NarrowedBracket3.m01_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket3.m01_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket3.cutLog_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket3.cutLog_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket3.cutLog_sharp_strict
#print axioms Phys.Algebra.NarrowedBracket3.cutLog_sharp_nested
#print axioms Phys.Algebra.NarrowedBracket3.invAlphaZero_narrowed3_bracket
#print axioms Phys.Algebra.NarrowedBracket3.dressed_narrowed3_bracket
#print axioms Phys.Algebra.NarrowedBracket3.invAlphaZero_narrowed3_strict
#print axioms Phys.Algebra.NarrowedBracket3.invAlphaZero_narrowed3_width_lt
#print axioms Phys.Algebra.NarrowedBracket3.invAlphaZero_narrowed3_nested
#print axioms Phys.Algebra.NarrowedBracket3.invAlphaZero_narrowed3_gt_waypoint
#print axioms Phys.Algebra.NarrowedBracket3.narrowedBracket3_landing

-- D5-next-4 — ARC-D THE DIGITS: THE NARROWING CAMPAIGN, NODE 5 — SHARPEN THE m01 FLOOR FURTHER (via
--   the DEEPER cutCos(2/9) reading) AND SQUEEZE 1/cutPi (split@5 tight-factor / split@6)
--   (Phys/Algebra/NarrowedBracket4.lean). BOTH residual fronts sharpened again: (1) the m01 floor was
--   NOT irreducible — reading the SAME cycle-phase cosine numeral cutCos(2/9) one term deeper (split@4,
--   p ∈ [975410084/1e9,975410086/1e9], width 2e-9, ≈165× tighter) crushes mass0/mass1 ∈
--   [347744/100,86937/25] (≈108× tighter) → cutLog ∈ [815405/1e5,815411/1e5] (width 6e-5, exp idx
--   21/22); (2) 1/cutPi SQUEEZED via split@5 lower (tightened remainder factor 103/100) / split@6 upper
--   → 1/cutPi ∈ [500000/1570797,1000000/3141541] (≈5.4e-6). Re-composed the D4 pipeline to a strictly
--   narrower (≈15×) certified two-sided rational bracket of the derived 1/α(0) at the derived census.
--   Same engine (cutCos_bracket) reads BOTH cutPi's least zero AND cutCos(2/9). NO empirical number; the
--   1/cutPi cos-positivity nlinarith margin is the honest W9 ceiling flagged for the successor.
#print axioms Phys.Foundation.ContinuumQ.partialCos_six
#print axioms Phys.Foundation.ContinuumQ.cutCos_15707970_neg
#print axioms Phys.Foundation.ContinuumQ.split5_tightfactor_poly_pos
#print axioms Phys.Foundation.ContinuumQ.split5_tightfactor_rem_bound
#print axioms Phys.Foundation.ContinuumQ.cutCos_pos_of_lt_15707705
#print axioms Phys.Foundation.ContinuumQ.leastCosZero_le_15707970
#print axioms Phys.Foundation.ContinuumQ.le_leastCosZero_15707705
#print axioms Phys.Foundation.ContinuumQ.cutPi_bracket_split6
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_bracket_split6
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_split6_strict
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_split6_nested
#print axioms Phys.Foundation.ContinuumQ.partialCos_two_ninths_four
#print axioms Phys.Algebra.NarrowedBracket4.pB_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket4.pB_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket4.wB_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket4.wB_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket4.rB_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket4.rB_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket4.wp_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket4.wp_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket4.wr_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket4.wr_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket4.b0_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket4.b0_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket4.b1_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket4.b1_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket4.mass0_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket4.mass0_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket4.mass1_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket4.mass1_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket4.m01_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket4.m01_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket4.cutLog_lo_sharp
#print axioms Phys.Algebra.NarrowedBracket4.cutLog_hi_sharp
#print axioms Phys.Algebra.NarrowedBracket4.cutLog_sharp4_strict
#print axioms Phys.Algebra.NarrowedBracket4.cutLog_sharp4_nested
#print axioms Phys.Algebra.NarrowedBracket4.invAlphaZero_narrowed4_bracket
#print axioms Phys.Algebra.NarrowedBracket4.dressed_narrowed4_bracket
#print axioms Phys.Algebra.NarrowedBracket4.invAlphaZero_narrowed4_strict
#print axioms Phys.Algebra.NarrowedBracket4.invAlphaZero_narrowed4_width_lt
...
-- N### — ARC-D D5-next-10 (NarrowedBracket10): THE NARROWING CAMPAIGN, node 11 — LIFT 1/cutPi's whole bracket onto a 1e10 GRID via the SAME double-double-angle route (two applications of the fold's own cutCos_double, one digit deeper), pushing leastCosZero's LOWER bound to the pi/2 1e10-grid floor 15707963267/1e10 and its UPPER to the ceiling 15707963268/1e10 (split@8), sharpening 1/cutPi ~10x from BOTH ends; re-composed 1/alpha(0) ~1.09x narrower (cutLog now the binding residual).
#print axioms Phys.Foundation.ContinuumQ.cutCos_gt_pi8_10
#print axioms Phys.Foundation.ContinuumQ.cutCos_pos_of_lt_15707963267
#print axioms Phys.Foundation.ContinuumQ.le_leastCosZero_15707963267
#print axioms Phys.Foundation.ContinuumQ.cutCos_15707963268_neg
#print axioms Phys.Foundation.ContinuumQ.leastCosZero_le_15707963268
#print axioms Phys.Foundation.ContinuumQ.cutPi_bracket_ext5
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_bracket_ext5
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_ext5_strict
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_ext5_nested
#print axioms Phys.Algebra.NarrowedBracket10.invAlphaZero_narrowed10_bracket
#print axioms Phys.Algebra.NarrowedBracket10.dressed_narrowed10_bracket
#print axioms Phys.Algebra.NarrowedBracket10.invAlphaZero_narrowed10_strict
#print axioms Phys.Algebra.NarrowedBracket10.invAlphaZero_narrowed10_width_lt
...
-- N### — ARC-D D5-next-12 (NarrowedBracket12): THE NARROWING CAMPAIGN, node 13 — SHARPEN 1/cutPi (once again the sole binding residual after the split@6 cutLog collapse) via a 1e11-grid lift of its whole bracket using the SAME banked double-double-angle route (two applications of the fold's own cutCos_double, one digit deeper): leastCosZero's LOWER bound pushed to the true pi/2 1e11-grid floor 157079632679/1e11 (the UPPER bound is the SAME rational at both grids, so the split@8 upper sign is reused verbatim), hence 1/cutPi [1250000000/3926990817, 50000000000/157079632679] (width ~2.03e-12, ~10x narrower); cutLog reused verbatim from the parent; re-composed 1/alpha(0) [12007329939722/176714586765, 32019546505738/471238898037] (width ~3.50e-11), ~8.5x narrower and NOW BELOW measured precision (the north-star crossing).
#print axioms Phys.Foundation.ContinuumQ.cutCos_gt_pi8_11
#print axioms Phys.Foundation.ContinuumQ.cutCos_pos_of_lt_157079632679
#print axioms Phys.Foundation.ContinuumQ.le_leastCosZero_157079632679
#print axioms Phys.Foundation.ContinuumQ.cutPi_bracket_ext6
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_bracket_ext6
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_ext6_strict
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_ext6_nested
#print axioms Phys.Algebra.NarrowedBracket12.invAlphaZero_narrowed12_bracket
#print axioms Phys.Algebra.NarrowedBracket12.dressed_narrowed12_bracket
#print axioms Phys.Algebra.NarrowedBracket12.invAlphaZero_narrowed12_strict
#print axioms Phys.Algebra.NarrowedBracket12.invAlphaZero_narrowed12_width_lt
...
-- N### — ARC-D D8 (FreezeoutComposition): THE FREEZE-OUT COMPOSITION — compose the D2 freeze-out summand the D7 gate named as missing, and establish its QUANTITATIVE CHARACTER as a theorem. MARQUEE FINDING (corrects the D7 conjecture that the freeze-out is the DOMINANT contribution): the three DERIVED plateau censuses total EXACTLY 9 (freezeout_total_census: 11/3+10/3+2), so the freeze-out summand = κ·(11/3)cutLog rb + κ·(10/3)cutLog rc + κ·2cutLog rl (freezeout_closed), BOUNDED by κ·9·cutLog R for edges ≤ R (freezeout_bounded) — a bounded, logarithmically-small census refinement, NOT the dominant summand. The composed endpoint = partial numeral + freeze-out (composed_split, = D7 attestation_tower_split at chargeTraceDepth), so it exceeds the certified partial numeral by AT MOST κ·9·cutLog R (composed_bounded ≤ 32019546505738/471238898037 + κ·9·cutLog R), while genuinely screening above it (composed_gt_partial). THEOREM-EXACT now; ROUTE-NOT-YET-FOUND (never asserted/fitted): the edge ratios rb,rc,rl as closed reals of Cut (the quark mass ℝ-descent — verified route-not-yet-found across Z3/X9/ZArcValidationCapstone/SEED_MASSES) AND the dominant missing structural summand of the genuine 1/α(0), both handed to the ONE directed route-finder successor. The composition stays PARTIAL; the measured 1/α(0)~137.036, PDG quark masses, and Λ_QCD are removable prose only; no empirical number in any proof; truncating at measured precision forbidden.
#print axioms Phys.Algebra.FreezeoutComposition.freezeout_total_census
#print axioms Phys.Algebra.FreezeoutComposition.freezeout_closed
#print axioms Phys.Algebra.FreezeoutComposition.freezeout_bounded
#print axioms Phys.Algebra.FreezeoutComposition.composed_split
#print axioms Phys.Algebra.FreezeoutComposition.composed_bounded
#print axioms Phys.Algebra.FreezeoutComposition.composed_gt_partial
#print axioms Phys.Algebra.FreezeoutComposition.freezeout_bound_pos
...
#print axioms Phys.Algebra.CasimirProjectionSelectsS.projectedS_factorization
...
#print axioms Phys.Algebra.CasimirProjectionSelectsS.projectedS_below_casimirRatio
...
#print axioms Phys.Algebra.CasimirProjectionSelectsS.projectedS_rejects_ratioTempered
#print axioms Phys.Algebra.CasimirProjectionSelectsS.projectedS_rejects_doublingTempered
#print axioms Phys.Algebra.CasimirProjectionSelectsS.projectedS_below_temperings
...
-- DressingSeamResolved (ARC-D REMAINDER, t_c488fbdc): the dressing/recombination seam RESOLVED — the
-- depth-dressing of the assembled tower is way-point-FORBIDDEN drift. The banked assembly composes with
-- the LEADING κ₀=1/(3·cutPi) and reproduces the banked exact way-points 1582/27 (electroweak, X6) and
-- 190/3 (confinement, Z4); the D2c/D2d depth-dressing κ(w)=κ₀/(1−w) at the DERIVED weight w=1/3 MOVES
-- both (1582/27→602/9, 190/3→74), failing the free instrument-check (SEED_DIGITS §D4/§D6), and
-- reproduces them ONLY at w=0. So branch (a): the ×1.465 dressing is drift (the census-in-census content
-- is already inside the banked all-orders band edges); the genuine composed 1/α(0) is the way-point-
-- consistent leading-κ recombined tower invAlphaEM=invAlphaZero+70 (D2b composed_endpoint) + the banked
-- determined freeze-out summand (parent). THEOREM-EXACT identities/inequalities of Cut. ROUTE-COMPLETE:
-- the composition-completeness barrier the parent named is discharged; the ≥15-digit narrowing of the
-- now-unambiguous leading-κ composed numeral is handed to the directed successor (D7→D8→hand M1). No fit,
-- no empirical number (137.036, 137.95, dressed ~150, 602/9, 74 removable orientation prose; fit s≈1.9
-- named only to exclude — the WAY-POINTS decide the seam, not the measured value).
#print axioms Phys.Algebra.DressingSeamResolved.leading_topBand
#print axioms Phys.Algebra.DressingSeamResolved.leading_conf
#print axioms Phys.Algebra.DressingSeamResolved.totalScreening_topBand
#print axioms Phys.Algebra.DressingSeamResolved.dressed_topBand_moves
#print axioms Phys.Algebra.DressingSeamResolved.dressed_conf_moves
#print axioms Phys.Algebra.DressingSeamResolved.dressed_topBand_at_w0
#print axioms Phys.Algebra.DressingSeamResolved.dressed_conf_at_w0
#print axioms Phys.Algebra.DressingSeamResolved.dressed_reproduces_only_at_w0
#print axioms Phys.Algebra.DressingSeamResolved.resolved_composed_is_leading
#print axioms Phys.Algebra.DressingSeamResolved.dressing_seam_resolved
#print axioms Phys.Algebra.DressingSeamResolved.dressed_topBand_ne
#print axioms Phys.Algebra.DressingSeamResolved.dressed_conf_ne
...
-- D7NarrowingRung1 (ARC-D THE DIGITS, t_c464fa87): first narrowing rung — sharpen the three dominant edge logs → re-assembled ~9-sig-digit certified bracket of the recomposed endpoint AS 1/α(0).
#print axioms Phys.Algebra.D7NarrowingRung1.mass0_clean_lo
#print axioms Phys.Algebra.D7NarrowingRung1.mass0_clean_hi
#print axioms Phys.Algebra.D7NarrowingRung1.cutLog_b0_sharp
#print axioms Phys.Algebra.D7NarrowingRung1.b2_sharp_lo
#print axioms Phys.Algebra.D7NarrowingRung1.b2_sharp_hi
#print axioms Phys.Algebra.D7NarrowingRung1.mass2_clean_lo
#print axioms Phys.Algebra.D7NarrowingRung1.mass2_clean_hi
#print axioms Phys.Algebra.D7NarrowingRung1.invMass2_sharp
#print axioms Phys.Algebra.D7NarrowingRung1.cutLog_b2_sharp
#print axioms Phys.Algebra.D7NarrowingRung1.q_sharp_lo
#print axioms Phys.Algebra.D7NarrowingRung1.q_sharp_hi
#print axioms Phys.Algebra.D7NarrowingRung1.mbRatio_sharp_lo
#print axioms Phys.Algebra.D7NarrowingRung1.mbRatio_sharp_hi
#print axioms Phys.Algebra.D7NarrowingRung1.invMbRatio_sharp
#print axioms Phys.Algebra.D7NarrowingRung1.cutLog_mb_sharp
#print axioms Phys.Algebra.D7NarrowingRung1.cutLog_m01_sharp
#print axioms Phys.Algebra.D7NarrowingRung1.endpoint_core_s1
#print axioms Phys.Algebra.D7NarrowingRung1.cutLog_bMass0_sharp
#print axioms Phys.Algebra.D7NarrowingRung1.cutLog_bMass2_sharp
#print axioms Phys.Algebra.D7NarrowingRung1.recomposedEndpoint_restated_sharp
#print axioms Phys.Algebra.D7NarrowingRung1.recomposedEndpoint_lt_137_sharp
#print axioms Phys.Algebra.D7NarrowingRung1.sharp_nested_in_coarse
...
-- TopAnchorInsertionPinning (ARC-M/O2 KEYSTONE, t_c748d2d6, OWNER-AUTHORIZED huc CAMPAIGN node 2): DERIVE THE UP-SECTOR TOP-AT-ANCHOR BORN-SQUARE PINNING Mu^2=M*ewClosureRatio AB INITIO. N577 derived the candidate top-anchor huc:(Mu/Mlam)^2=1/confBundle from two Born-square sector-anchor pinnings with the shared closure anchor M cancelling (huc_from_born_anchors), proved the confinement-floor half DEFINITIONAL (confAnchor_is_confScale=confinementScale M), excluded mis-power (huc_not_mispower) and refuted double-count (rung_is_one_object). The ONE remaining open half — the last route-not-yet-found piece of huc — was the up-sector top-at-anchor Born-square pinning Mu^2=M*ewClosureRatio (=v). THIS node derives it. THE THEORY-NATIVE HEART: the empty cascade-insertion product. The banked arc-O2 chain (ScaleTowerDischargeArcM, N417) writes the absolute-scale cascade as the electroweak anchor dressed by cascade-insertion factors: absScaleChainR φ τ ℓ=ewClosureRatio*(φ*s1BornProb)*τ*ℓ. The down/light sector carries a NON-empty insertion bundle [cutCos foldPhase*s1BornProb, cutCos(2/3)] (each a strictly-positive sub-unit Born amplitude) that suppresses it STRICTLY BELOW the anchor (banked absScaleChainDerived_lt_anchor). The top is the HEAVIEST cascade member: its cascade insertion DEPTH is ZERO, so its insertion list is EMPTY, and the empty insertion product is the identity 1 (List.prod_nil, universal fact of the insertion monoid — NOT a fitted 1). Its chain value collapses to the anchor itself, ewClosureRatio=v/M. So Mu^2=M*insertionChain []=M*ewClosureRatio (top_at_anchor_pinning). THE DISCRIMINATOR IS FORCED BY THE COUNTING, NOT TARGET-SHAPED: at-anchor IFF trivial-insertion (atAnchor_iff_trivial_insertion: since ewClosureRatio!=0, insertionChain L=ewClosureRatio <-> L.prod=1); one sub-unit insertion => strictly below (one_subunit_insertion_below_anchor); the banked non-empty bundle lands strictly below (downLight_below_anchor, wrapping absScaleChainDerived_lt_anchor). So the top's ZERO insertion depth FORCES it to the anchor; any non-zero depth would put it strictly below. The counting selects the anchor; nothing bends toward 137.036. huc FULLY DERIVED: feeding the top-at-anchor pinning + the definitional floor half into N577's huc_from_born_anchors yields (Mu/Mlam)^2=1/confBundle as a THEOREM (huc_fully_derived) — the candidate promoted, the last anchor half closed. downLight_is_insertionChain ties the framing EXACTLY to the banked absScaleChainDerived (NOT free-floating). Non-vacuity: top_pinning_satisfiable (M=1, Mu=cutExp(-14pi/3)=sqrt(v/M)), anchor_split_strict (non-empty bundle < empty=anchor), top_above_floor (confinementScaleRatio<ewClosureRatio, Lambda/v=confBundle<1). HONEST GRADE: all theorem-exact now; the huc campaign's remaining node is the recomposition/re-attestation of the freeze-out endpoint with huc now a theorem — the directed successor. NO-FIT: measured 1/alpha(0), v, m_t, Lambda_QCD, PDG masses removable prose; no empirical number in any proof. 13 decls foundations-only (1 def + 12 theorems audited); C577 bites 1=577.
...
-- HucDischargedFreezeoutEndpoint (ARC-M/O2 KEYSTONE, t_9ec9d521, OWNER-AUTHORIZED huc CAMPAIGN node 3): RECOMPOSE THE FREEZE-OUT ENDPOINT WITH huc NOW A THEOREM. N576 proved the confinement rung 8*cutPi/3 enters the freeze-out edge-logs SOLELY via the light edge, SOLELY via light_log_carries_rung, which CARRIED the candidate top-anchor huc:(Mu/Mlam)^2=1/confBundle as an explicit HYPOTHESIS (escalating the double-count discriminator to the owner). N577+N578 DERIVED huc as a theorem of Cut (Born-square anchor reduction with M cancelling; confinement-floor half definitional; up-sector top half forced by the EMPTY cascade-insertion product). THIS node recomposes the endpoint with huc discharged. (1) THE DISCHARGE: the light-edge rung is supplied by the derived huc_fully_derived (fed the top amplitude's empty-insertion pinning Mu^2=M*insertionChain [] and the definitional floor Mlam^2=M*confinementScaleRatio), so cutLog(edgeLight Md (Mlam^2))=cutLog mbRatioDerived+8*cutPi/3+cutLog(bMass 2) holds with NO free huc (light_log_rung_huc_discharged). (2) THE WITNESS: at the banked half-rung amplitudes M=1, Mu=cutExp(-14pi/3)=sqrt(v/M), Mlam=cutExp(-6pi)=sqrt(Lambda/M) the rung identity holds with NO abstract anchor hypotheses (light_rung_at_witness) — the rung stands on the derived tower half-rungs alone, only the norm leg hud remaining (a separate rung-free matter). (3) THE ONE-CAUSE RE-ATTESTATION: the N576 double-count question RESOLVED as a theorem — the light gem 40/27 IS the band screening at the light census 5/3 (gem_is_light_band_screen), the full band 128/27 IS the band screening at the full census 16/3 (bandScreen_conf_exact), both screen the ONE derived ratio confBandRatio whose rung is 8*cutPi/3 (confRung_val), which is EXACTLY the discharged light-edge rung cutLog(1/confBundle)=cutLog confBandRatio (rung_is_one_object); the light census is a STRICT SUBSET of the full census (5/3<10/3<16/3). ONE derived value in two DIFFERENT censuses — the ONE-CAUSE signature, reading (i) forced. (4) THE D7 RESTATEMENT (endpoint UNCHANGED — huc was always the correct rung value): recomposedEndpoint in [1363071880/1e7,1363071883/1e7]=[136.307188,136.3071883] (~9 sig digits, bare_endpoint_restated), recomposedEndpointDressed in [1370984/1e4,1371006/1e4]=[137.0984,137.1006] (dressed_endpoint_restated), recomposedEndpoint<137 (bare_endpoint_lt_137). Bracket is NOT measured 137.036 and NOT yet 15 sig digits — a continue-the-hunt signal (residual width bottlenecked by the DERIVED inputs' numeral widths, not the now-discharged rung), NOT an arc exit; the >=15-digit floor is route-not-yet-found, the directed successor (deeper input narrowing / next earlier layer). Non-vacuity: discharged_rung_pos (0<8pi/3), two_censuses_distinct (5/3!=16/3), bare_dressed_disjoint (bare<dressed). NO-FIT: measured 1/alpha(0), v, m_t, Lambda_QCD, PDG masses removable prose; no empirical number in any proof. 13 theorems foundations-only; C578 bites 1=578.
#print axioms Phys.Algebra.HucDischargedFreezeoutEndpoint.light_log_rung_huc_discharged
#print axioms Phys.Algebra.HucDischargedFreezeoutEndpoint.rung_isolated_huc_discharged
#print axioms Phys.Algebra.HucDischargedFreezeoutEndpoint.light_rung_at_witness
#print axioms Phys.Algebra.HucDischargedFreezeoutEndpoint.gem_is_light_band_screen
...
#print axioms Phys.Algebra.HucDischargedFreezeoutEndpoint.bare_endpoint_lt_137
#print axioms Phys.Algebra.HucDischargedFreezeoutEndpoint.discharged_rung_pos
#print axioms Phys.Algebra.HucDischargedFreezeoutEndpoint.discharge_satisfiable
...
-- FrameAuditRecombinationArchitecture (arc-D THE DIGITS, t_80a7e457, OWNER FRAME AUDIT F1 — THE RECOMBINATION ARCHITECTURE): the narrowing recipe is GATED (the dressed endpoint is a CONFIRMED DEFECTIVE value); every layer WITHIN the frame is audited, so the defect lives in the frame's own claims. F1 re-derives AB INITIO which of two banked architectures the endpoint is forced to compose. ARCH-A (one-tower-plus-constant, RecombinedEndpoint.invAlphaEM = invAlphaZero + 70 = 112 + totalScreeningWith chargeTraceDepth): BOTH channels at the full charge census, isospin at its BARE matter census. ARCH-B (run-both-channels-then-recombine, RecomposedRunningEndpoint.recomposedInvAlphaEM = 112 + totalScreeningWith recomposedCharge, recomposedCharge = netIsoDepth s + hyperDepth = 16/3 - s): isospin at its NET running census. The single-parameter family recombArch t := 112 + totalScreeningWith (netIsoDepth t + hyperDepth) collapses onto ARCH-A at t=0 (recombArch_zero_eq_additive, via netIsoDepth 0 + hyperDepth = chargeTraceDepth by census_additive Q=T3+Y) and onto ARCH-B at t=projectedS (recombArch_projectedS_eq_recomposed). So ARCH-A IS ARCH-B at the s=0 switch-off; the fold FORBIDS t=0 on two independent banked grounds (ONE CAUSE = the Z1 negative isospin gather self-census): (i) Z1 channel_gather_asymmetry (isospin gather self-census < 0, abelian = 0), (ii) CasimirProjectionSelectsS projectedS = 1/8 > 0. TWO banked adjudicators both => ARCH-B: (1) ENDPOINT: recombArch 0 - recombArch projectedS = bandScreen projectedS topBandRatio = 7/18 (architecture_shift_exact) - ARCH-A over-counts the top-band census by the s slice Z1 removes; (2) MIXING (X7 genre): ARCH-A FREEZES sin^2theta_W = 3/8 (archA_freezes_mixing, twoChannel_switchoff) but the banked forced reading DEPARTS < 3/8 (archB_departs_mixing, twoChannel_mixing_departs) - ARCH-B reproduces it, ARCH-A contradicts it. The X7 EM way-point invAlphaZero [(chargeTraceDepth, topBandRatio)] = 1582/27 (em_waypoint_shared_anchor) is s-INDEPENDENT - the common anchor, not the discriminator; the +70 ceiling is COMMON to both architectures (ceiling_common_not_defect), so it is NOT the defect. VERDICT: ARCH-B (run-both-recombine) is FORCED; ARCH-A (the +70 constant weld) is the Z1-forbidden s=0 switch-off; the defect is composing the non-abelian isospin channel at its bare matter census instead of its net running census. RECONCILIATION: the banked endpoint already uses ARCH-B above v (6923/54 has s=1/8 folded in), so F1 CONFIRMS the above-v architecture and FIXES F2's arena to per-channel net-census running. THEOREM-EXACT, foundations-only. NO-FIT (measured 1/alpha(0)~137.036 / sin^2theta_W~0.231 removable prose; architecture adjudicated by the fold's own Z1 structure, not by where a measured value sits). 10 theorems foundations-only; C580 bites 1=580.
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.recombArch_ceiling_common
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.netIsoDepth_zero_add_hyper
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.recombArch_zero_eq_additive
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.recombArch_projectedS_eq_recomposed
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.architecture_shift_exact
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.architectures_differ_at_topBand
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.forced_param_ne_zero
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.ceiling_common_not_defect
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.archA_freezes_mixing
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.archB_departs_mixing
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.archA_vs_archB_mixing_distinct
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.em_waypoint_shared_anchor
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.archB_below_archA_topBand
#print axioms Phys.Algebra.FrameAuditRecombinationArchitecture.frameAuditRecombinationArchitecture_landing

-- FrameAuditDressingScope (arc-D THE DIGITS, t_8ba2ab5c, OWNER FRAME AUDIT F2 — THE DRESSING SCOPE in the F1-forced ARCH-B arena): SUCCEEDS F1 N580b. The narrowing recipe is GATED (the dressed endpoint 137.0996710997 is a CONFIRMED DEFECTIVE value); F1 fixed the arena (ARCH-B run-both-recombine forced, isospin at its NET running census netIsoDepth s; ARCH-A the +70-constant weld is the Z1-forbidden s=0 switch-off). F2 re-derives AB INITIO the SECOND surviving structural claim: WHICH object the all-orders 3/2 = 1/(1-w) (w = depthWeight = 1/3, the channel-independent mean Born self-overlap over the fold's ONE return surface) dresses. THREE candidate scopes: SCOPE-(a) UNIFORM WHOLE-TOWER — FORBIDDEN (DressingSeamResolved: moves both banked exact way-points 1582/27 -> 602/9 (dressed_topBand_moves), 190/3 -> 74 (dressed_conf_moves), reproducing them only at w=0; the high-band census-in-census content is already inside the all-orders transmutation-scale band edges, so re-dressing double-counts); SCOPE-(b) PER-BAND VARYING — FORBIDDEN (LowTailFoldForcedWeight: the per-band varying weight COLLAPSES to the single fold constant, bandVaryingScreen (withWeight depthWeight lowTail) = (3/2)*totalScreening lowTail (foldForcedLowTailScreen); per-band variation has no fold source and its only motive is to tune = a FIT; the per-band slot is a genuine knob the fold FIXES, perBand_knob_real); SCOPE-(c) THE RESUMMED-vs-UNRESUMMED PARTITION — FORCED (the 3/2 dresses ONLY the surviving-kappa un-resummed low-tail running cInner: recomposedEndpointDressed = 2425/18 + (3/2)*kappaLeading*cInner (recomposedEndpointDressed_closed), EXEMPTING the already-all-orders-resummed base recomposedEndpointDressed - (3/2)*kappaLeading*cInner = 2425/18 (dressed_offsets_base), the base being 2425/18 = 7179/54 confinement way-point + 16/9 cutPi-cancelled census gem, base_eq_waypoint_plus_gem). THE F1<->F2 TIE: the weight is CHANNEL-INDEPENDENT depthWeight = 1/3 (weight_derived_not_free) — F1 fixes the CENSUS per channel (netIsoDepth s), F2 fixes the one shared WEIGHT + the content SCOPE; the two halves weld into the banked recomposedEndpointDressed composition. VERDICT: SCOPE-(c) is FORCED (the ONLY scope that reproduces the way-points AND is fit-free); SCOPE-(a) is way-point-forbidden; SCOPE-(b) is the fold-killed tuning knob. This COMPLETES the frame audit (F1 census + F2 weight/scope both re-derived ab initio in the forced arena) and confirms recomposedEndpointDressed as the F1+F2-consistent composition. THEOREM-EXACT, foundations-only. NO-FIT (measured 1/alpha(0)~137.036 removable prose; the fit s~1.9 / the band-varying window (13/9,40/27) named only to be EXCLUDED; scope adjudicated by the fold's own way-points + return-surface geometry, not by where a measured value sits). 12 theorems foundations-only; C581 bites 1=581.
#print axioms Phys.Algebra.FrameAuditDressingScope.scopeA_moves_topBand
#print axioms Phys.Algebra.FrameAuditDressingScope.scopeA_moves_conf
#print axioms Phys.Algebra.FrameAuditDressingScope.shared_waypoints
#print axioms Phys.Algebra.FrameAuditDressingScope.scopeB_collapses
#print axioms Phys.Algebra.FrameAuditDressingScope.scopeB_knob_real
#print axioms Phys.Algebra.FrameAuditDressingScope.scopeC_closed
#print axioms Phys.Algebra.FrameAuditDressingScope.scopeC_exempts_base
#print axioms Phys.Algebra.FrameAuditDressingScope.exempt_base_is_resummed
#print axioms Phys.Algebra.FrameAuditDressingScope.weight_channel_independent
#print axioms Phys.Algebra.FrameAuditDressingScope.waypoint_move_real
#print axioms Phys.Algebra.FrameAuditDressingScope.scopes_distinct_topBand
#print axioms Phys.Algebra.FrameAuditDressingScope.scopeC_dresses
#print axioms Phys.Algebra.FrameAuditDressingScope.frameAuditDressingScope_landing

-- FrameAuditedCompositionReattestation (arc-D THE DIGITS, t_4d2581c1, RECOMPOSE + RE-ATTEST closing the OWNER FRAME AUDIT): SUCCEEDS F1 (N580b) + F2 (N581). The freeze-out endpoint narrowing was GATED (the dressed endpoint 137.0996710997 is a CONFIRMED DEFECTIVE value); the owner FRAME AUDIT re-derived the frame's two surviving structural claims ab initio in the forced arena — F1 (the recombination architecture, ARCH-B run-both-recombine forced) + F2 (the dressing scope, SCOPE-(c) resummed-vs-unresummed forced) — both CONFIRMING the banked recomposedEndpointDressed = 2425/18 + (3/2)*kappaLeading*cInner composition. This node RE-ATTESTS the D7 composition-completeness over that frame-audited object (assembly of banked objects, not new derivation): (A) the F2 dressing scope holds (reattest_scopeC_closed / reattest_base_exempt / reattest_base_is_resummed, 2425/18 = 7179/54 + 16/9); (B) the F1 architecture is the forced ARCH-B (reattest_architecture_shift = bandScreen projectedS topBandRatio, reattest_arch_forced projectedS != 0, reattest_arch_direction ARCH-B below ARCH-A); (C) the F1<->F2 tie (reattest_weight_tie depthWeight = 1/3 != 0, != 1); (D) the D7 bare census-completeness (reattest_bare_census_complete full re-export: closed form + census partition 16/3 = 10/3 + 2 + both way-points 6923/54 & 7179/54 + enumeration exhaustiveness finrank Q Uhol = 3 + termination) AND the bare<->dressed weld (reattest_dressed_weld: recomposedEndpointDressed = recomposedEndpoint + (1/2)*kappaLeading*cInner) — the frame-audited dressed object differs from the census-complete bare object by EXACTLY the fold-forced depth-2 increment on the SAME cInner running content, base identical, so census-completeness carries to every dressed contribution; (E) teeth (census_gem_real 2425/18 != 7179/54, dressing_real, increment_pos 0 < (1/2)*kappaLeading*cInner). VERDICT: the frame-audited composition is COMPLETE — every banked contribution INCLUDED or proven exempt/zero — so the residual endpoint defect is NOT in the frame's two surviving structural claims, and the >=15-sig-digit floor is INSTRUMENT precision handed to the ONE directed narrowing successor. THEOREM-EXACT (exact identities & inequalities of Cut), foundations-only subset {propext,Classical.choice,Quot.sound}; NO route-not-yet-found in this node (the re-attestation is a proved theorem). NO-FIT (measured 1/alpha(0) ~ 137.036 removable prose; no empirical number in any statement or proof). 13 theorems foundations-only; C582 bites 1 = 582. ONE directed successor: D7 Narrowing Rung 3 (the reverted, de-risked ext7 1/cutPi + s7 L_m01 instrument work ports directly) -> D7 -> D8.
#print axioms Phys.Algebra.FrameAuditedCompositionReattestation.reattest_scopeC_closed
#print axioms Phys.Algebra.FrameAuditedCompositionReattestation.reattest_base_exempt
#print axioms Phys.Algebra.FrameAuditedCompositionReattestation.reattest_base_is_resummed
#print axioms Phys.Algebra.FrameAuditedCompositionReattestation.reattest_architecture_shift
#print axioms Phys.Algebra.FrameAuditedCompositionReattestation.reattest_arch_forced
#print axioms Phys.Algebra.FrameAuditedCompositionReattestation.reattest_arch_direction
#print axioms Phys.Algebra.FrameAuditedCompositionReattestation.reattest_weight_tie
#print axioms Phys.Algebra.FrameAuditedCompositionReattestation.reattest_bare_census_complete
#print axioms Phys.Algebra.FrameAuditedCompositionReattestation.reattest_dressed_weld
#print axioms Phys.Algebra.FrameAuditedCompositionReattestation.census_gem_real
...
-- D7NarrowingRung4 (arc-D THE DIGITS, t_982a3a98, RESUME the >=15-sig-digit narrowing): SUCCEEDS N583. The dominant residual after ext7 was again kappa = 1/cutPi (1e12 grid); W9 MEASURE-FIRST showed the ticket's 1e13 grid lands BARE ~15.06 but DRESSED only ~14.89 (the dressed inner combination ~22.4 is ~50% larger than the bare's ~14.94, so the kappa-width contribution alone floors the dressed short of 15 on the 1e13 grid), while the 1e14 grid lands BOTH endpoints >=15 in ONE node. Following the theory (>=15 on the REAL >137 dressed prediction) over the arc's stated grid, this node LIFTED the whole 1/cutPi bracket onto a 1e14 grid via the SAME banked double-double-angle route (two applications of the fold's own cutCos_double, folding near-pi/2 positivity to a well-conditioned near-pi/8 one -- LOWER by split@7 positivity le_leastCosZero_157079632679489, UPPER by DDA negativity leastCosZero_le_15707963267949 via IVT), giving 1/cutPi in [5000000000000/15707963267949, 50000000000000/157079632679489] (width ~2.03e-15, ~100x narrower than ext7, nested strictly inside), reused the split@7 L_m01, AND deepened the three co-dominant edge logs one rung to the 1e14 grid (reading the SAME banked s7 amplitude / closed-form brackets through the exp instrument one index deeper: cutLog mass0 in [173372879495463/1e14, 173372879495464/1e14] at exp 20/21, cutLog mass2 in [-108872372522363/1e14, -108872372522362/1e14] at exp 15/17, cutLog mbRatioDerived in [-408930664000672/1e14, -408930664000670/1e14] at exp 26/29). Re-composing the D7 endpoint through the banked normal forms (recomposedEndpoint_cInner, recomposedEndpointDressed_normalform) via the abstract arithmetic cores endpoint_core_r4/dressed_core_r4 (transcendentals OUT): BARE recomposedEndpoint in [13630718814055173/1e14, 13630718814055178/1e14] = [136.30718814055173, 136.30718814055178] (width 5e-14, ~15.4 sig digits, nested strictly inside banked N583 [136.3071881405515, 136.3071881405528], < 137); DRESSED recomposedEndpointDressed in [13709967109971648/1e14, 13709967109971655/1e14] = [137.09967109971648, 137.09967109971655] (width 7e-14, ~15.3 sig digits, nested strictly inside banked N583 [137.0996710997162, 137.0996710997180], > 137). THEOREM-route, CERTIFIED (certified two-sided rational brackets of closed reals of Cut, no error bar), foundations-only subset {propext,Classical.choice,Quot.sound}. >= 15 sig digits on BOTH endpoints -- the campaign target reached. NO-FIT (every endpoint chosen by instrument certifiability at the chosen index -- split 7 / pi/2 grid 1e14 / exp indices -- not tuned to any measured value; measured 1/alpha(0) ~ 137.036 and pi removable orientation prose; no empirical number in any statement or proof). 20 theorems foundations-only; C584 bites 1 = 584. ONE directed successor: D7 exact-restate 1/alpha(0) at >=15 sig digits (the campaign floor reached) -> D8.
...
#print axioms Phys.Foundation.ContinuumQ.v_le_R_14
#print axioms Phys.Foundation.ContinuumQ.v_ge_9_10_14
#print axioms Phys.Foundation.ContinuumQ.cutCos_15707963267949_neg
#print axioms Phys.Foundation.ContinuumQ.leastCosZero_le_15707963267949
#print axioms Phys.Foundation.ContinuumQ.cutPi_bracket_ext8
#print axioms Phys.Foundation.ContinuumQ.inv_cutPi_bracket_ext8
#print axioms Phys.Algebra.D7NarrowingRung4.kappa_bracket_ext8
#print axioms Phys.Algebra.D7NarrowingRung4.cutLog_b0_ext8
#print axioms Phys.Algebra.D7NarrowingRung4.cutLog_b2_ext8
#print axioms Phys.Algebra.D7NarrowingRung4.cutLog_mb_ext8
#print axioms Phys.Algebra.D7NarrowingRung4.endpoint_core_r4
#print axioms Phys.Algebra.D7NarrowingRung4.dressed_core_r4
#print axioms Phys.Algebra.D7NarrowingRung4.recomposedEndpoint_restated_r4
#print axioms Phys.Algebra.D7NarrowingRung4.recomposedEndpointDressed_restated_r4
...
-- GQ campaign L0: the integer arithmetic of the fold
...
-- GQ N617 (N617): the pipeline — absorb, trade end-to-end, unroll, package
#print axioms Phys.Foundation.GaussForms.BQF.capture_absorb_D
