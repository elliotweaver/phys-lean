...
theorem so3_closure_FCFA :
  ...
  rw [show (⁅innerMul (slotA (1:O ℚ)) (slotB 1), innerMul (slotB (1:O ℚ)) (slotC 1)⁆ :
      Module.End ℚ (Matrix (Fin 3) (Fin 3) (O ℚ)))
        = innerMul (slotA 1) (slotB 1) * innerMul (slotB 1) (slotC 1)
          - innerMul (slotB 1) (slotC 1) * innerMul (slotA 1) (slotB 1) from Ring.lie_def _ _]
  apply LinearMap.ext; intro X
  apply Matrix.ext; intro i j
  fin_cases i <;> fin_cases j <;>
    (simp only [LinearMap.sub_apply, Module.End.mul_apply, innerMul_apply, jb,
