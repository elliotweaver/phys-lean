...
/-!
  # SCRATCH N677 — AlphaLandingCapstone: the referee battery
  PREREG: workbench/mirror-closure/PREREG-AIRTIGHT.md (extended, referee items).
  Recon: residual(30) < 0 worst-case (−982.9); 1/root ≥ 136.8 > 42; (2/5)/2 = 1/5 ≠ 1/3.
-/
