...
-- MEASURE: full 8-term sum for innerDeriv hI.
set_option maxHeartbeats 2000000 in
example : (∑ j, gForm (innerDeriv (hI : H ℚ) (bO j)) (innerDeriv (hI : H ℚ) (bO j))) = 16 := by
  rw [Fin.sum_univ_eight, e0', e1', e2', e3', e4', e5', e6', e7']
  simp only [gForm, reQ, innerDeriv_apply, adHom_apply, hI, CD.iota, Dbl.J, sub_eq_add_neg,
