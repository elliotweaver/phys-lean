...
/-- generic even/odd range split (length 2m+1). abel closes the reassociation. -/
...
/-- cc closed form (a,b separate), N323 cosCoeff_closed shape. -/
...
/-- Factored: ccCoeff = (-1)^N/(2N)! * ∑ C(2N,2k) a^(2k) b^(2(N-k)). -/
