/- PROBE (run 74, W9 MEASURE, decisive): is polarCross2(E)(X)(Y)=0 ABSTRACTLY for a
   NUCLEAR matrix E (LA/MA/RA) and ARBITRARY X,Y? If yes -> clean gmat-style abstract
   lemma, no coordinates, no centrality. If residual remains -> needs entry centrality. -/
import Phys.Algebra.JordanTower
import Mathlib.Data.Matrix.Basic
import Mathlib.Data.Matrix.Mul
import Mathlib.Tactic

namespace Probe74PC2
