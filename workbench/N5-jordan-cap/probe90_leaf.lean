/- PROBE 90: does cdsimp0 fully project a pc1 leaf to pure ℚ? Do full ext, cdsimp0, then
   trace ONE leaf goal to see if any octonion product remains unexpanded. -/
...
theorem pc1_00 (d0 d1 d2 : ℚ) (a b c p q r : O ℚ) :
  ...
  dgsimp
  ext
  case a.a.a => cdsimp0; trace_state; ring
  all_goals (cdsimp0; ring)
