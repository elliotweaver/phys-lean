/- PROBE 86: pc1 (0,0) — after scalar transport, what octonion identity remains?
   Apply dgsimp + distribute + transport, then trace the residual (should be d_k-scaled
   octonion associators). KILL 90s. -/
