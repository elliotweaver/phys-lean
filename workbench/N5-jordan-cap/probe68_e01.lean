/- PROBE (run 68, W9.2): EXTRACT the pieceB block-1 (0,1) goal after entrysimp, ocR opaque.
   (0,1) is an off-diagonal entry = 16 monomials, the SMALLEST. -/
import Phys.Algebra.HermitianJordan.Reduction
import Phys.Algebra.HermitianJordan.SinglePair
import Phys.Algebra.Alternative
import Mathlib.Tactic

namespace Probe68E01
...
theorem pieceB_e01_goal (d0 d1 d2 : ℚ) (a b c p : O ℚ) :
