/- PROBE 83: FULL pc2 (Dg)(Xz)(Xz) = 0, all 9 entries via Matrix.ext + fin_cases + dissolution.
   MEASURE cost. KILL 120s. -/
...
theorem pc2_zero (d0 d1 d2 : ℚ) (a b c p q r : O ℚ) :
    polarCross2 (Dg d0 d1 d2) (Xz a b c) (Xz p q r) = 0 := by
  apply Matrix.ext; intro i j
  simp only [Matrix.zero_apply]
  unfold polarCross2
  simp only [Matrix.add_apply, Matrix.sub_apply]
  fin_cases i <;> fin_cases j <;> dissolve
