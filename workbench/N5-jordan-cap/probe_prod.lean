/- PROBE (run 52): verify the production proof of jdef_single_pair closes with central_diag
   + nrm_* centrality, over generic CD (CD B). Test before banking to production. -/
...
-- generic central-element identity (NonAssocRing), the diagonal-entry workhorse
