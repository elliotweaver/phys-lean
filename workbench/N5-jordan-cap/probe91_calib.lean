/- PROBE 91: CALIBRATION. Does the coordinate route (ext<;>cdsimp0<;>ring) close pc2 (0,0)
   (known true via module)? If YES -> the route works, pc1 failure is size/alternativity-visibility.
   Also: prove a pure octonion alternativity identity (the asw associator d0-coefficient of pc1
   00) by coordinate ring to confirm ring closes octonion-ground identities. KILL 120s. -/
...
-- CALIBRATION 1: pc2 (0,0) via coordinate route (known true).
set_option maxHeartbeats 4000000 in
theorem pc2_00_coord (d0 d1 d2 : ℚ) (a b c p q r : O ℚ) :
