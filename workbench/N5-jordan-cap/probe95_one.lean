/- PROBE 95: ONE pure-octonion pc1 projector entry, max budget, long kill. Does ring close it,
   or genuinely fail? Diagnoses whether D-linearity route is viable. KILL 200s. -/
