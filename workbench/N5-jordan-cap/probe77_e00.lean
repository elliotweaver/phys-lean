/- MEASURE (run 77, W9): polarCross2 (Dg)(Xz)(Xz) entry (0,0) cost + close.
   Strategy: reduce Dg entries via dedicated lemmas (ocR OPAQUE), then ocR-central + abel. -/
...
-- Dg entry reduction lemmas (ocR opaque, kept abstract)
