...
example : (jdef Xw Yw 0 3).im.re.im = 4 := by
  ...
  simp only [sub_eq_add_neg, CD.mul_re, CD.mul_im, CD.star_re, CD.star_im,
    CD.add_re, CD.add_im, CD.neg_re, CD.neg_im, CD.zero_re, CD.zero_im,
    CD.iota, CD.e2, ιJ, Dbl.J,
    ...
    CD.one_re, CD.one_im, star_zero, star_one, mul_zero, zero_mul, mul_one, one_mul,
    add_zero, zero_add, neg_zero, neg_neg]
  norm_num
