/- PROBE 100: trace WHY cdsimp0 stalls on pc1(Proj0). Use EXACT Building.lean entrysimp+cdsimp0.
   trace_state right before ring. KILL via measure. -/
...
theorem pc1tr_00 (a b c p q r : CD (CD B)) :
