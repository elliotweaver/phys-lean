/- PROBE (run 52): the 3-generator zero-diagonal CORE diagonal (0,0) entry, octonion level,
   direct numeral indexing (clean octonion goal, no coordinate projection). -/
