/- MEASURE (run 77): test closers on the CONCRETE polarCross2 (0,0) goal (ocR central). -/
...
-- CLOSER A: full simp ocR set + abel
set_option maxHeartbeats 2000000 in
theorem pc2_00_A (d0 d1 d2 : ℚ) (a b c p q r : O ℚ) :
