...
-- universal zero-cell closer: full simp closes 0*a, star a*0, nested to fixpoint
local macro "zerocell" : tactic =>
  `(tactic| (entryexp; norm_num; try simp [ocRmulL, ocRmulR]; try abel))
...
theorem e01 (a b : O ℚ) (d0 d1 d2 : ℚ) :
  ...
  zerocell
set_option maxHeartbeats 800000 in
theorem e02 (a b : O ℚ) (d0 d1 d2 : ℚ) :
    (jb (slotA a) (jb (slotB b) (Dg d0 d1 d2)) - jb (slotB b) (jb (slotA a) (Dg d0 d1 d2))) 0 2 = 0 := by
  zerocell
set_option maxHeartbeats 800000 in
theorem e10 (a b : O ℚ) (d0 d1 d2 : ℚ) :
    (jb (slotA a) (jb (slotB b) (Dg d0 d1 d2)) - jb (slotB b) (jb (slotA a) (Dg d0 d1 d2))) 1 0 = 0 := by
  zerocell
set_option maxHeartbeats 800000 in
theorem e11 (a b : O ℚ) (d0 d1 d2 : ℚ) :
    (jb (slotA a) (jb (slotB b) (Dg d0 d1 d2)) - jb (slotB b) (jb (slotA a) (Dg d0 d1 d2))) 1 1 = 0 := by
  zerocell
set_option maxHeartbeats 800000 in
theorem e20 (a b : O ℚ) (d0 d1 d2 : ℚ) :
    (jb (slotA a) (jb (slotB b) (Dg d0 d1 d2)) - jb (slotB b) (jb (slotA a) (Dg d0 d1 d2))) 2 0 = 0 := by
  zerocell
set_option maxHeartbeats 800000 in
theorem e22 (a b : O ℚ) (d0 d1 d2 : ℚ) :
    (jb (slotA a) (jb (slotB b) (Dg d0 d1 d2)) - jb (slotB b) (jb (slotA a) (Dg d0 d1 d2))) 2 2 = 0 := by
  zerocell
