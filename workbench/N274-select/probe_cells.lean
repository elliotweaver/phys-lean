...
-- discover the closer for a representative a,b-position off-diagonal cell (0,1)
...
set_option maxHeartbeats 800000 in
theorem e21 (a b : O ℚ) (d0 d1 d2 : ℚ) :
    (jb (slotA a) (jb (slotB b) (Dg d0 d1 d2)) - jb (slotB b) (jb (slotA a) (Dg d0 d1 d2))) 2 1
      = (d2 - d1) • (star b * a) := by
  entryexp; norm_num
