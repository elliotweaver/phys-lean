...
theorem whole (a b : O ℚ) (d0 d1 d2 : ℚ) :
  ...
  fin_cases i <;> fin_cases j <;>
    (simp only [jb, slotA, slotB, slotC, Dg, Xz, Matrix.sub_apply, Matrix.add_apply,
      ...
      Fin.isValue, Fin.reduceEq, if_true, if_false, reduceIte] ;
     simp only [mul_zero, zero_mul, add_zero, zero_add, sub_zero, neg_zero, star_zero,
       mul_one, one_mul, sub_self, smul_zero] ;
     first
       | rfl
