...
-- WHOLE-MATRIX coordinate proof: fin_cases + common simp/norm_num + first over proven closers.
set_option maxHeartbeats 1600000 in
theorem innerMul_slot_diag_test (a b : O ℚ) (d0 d1 d2 : ℚ) :
  ...
  fin_cases i <;> fin_cases j <;>
    (simp only [jb, slotA, slotB, slotC, Dg, Xz, Matrix.sub_apply, Matrix.add_apply,
     ...
     first
       ...
       | (rw [ocRmulL, ocRmulR, ocRmulL, ocRmulR]; abel)
