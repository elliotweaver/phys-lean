...
theorem innerMul_slot_diag (a b : O ℚ) (d0 d1 d2 : ℚ) :
  ...
  fin_cases i <;> fin_cases j <;>
    simp only [innerMul_apply, jb, slotA, slotB, slotC, Dg, Xz, Matrix.sub_apply, Matrix.add_apply,
      ...
      Fin.isValue] <;>
    simp only [show (1:ℕ)=2 ↔ False by decide, show (2:ℕ)=1 ↔ False by decide,
    ...
    first
      ...
      | (rw [ocRmulR, ocRmulL, sub_smul]; abel)
      | (simp)
