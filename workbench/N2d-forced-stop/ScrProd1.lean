...
/-! local NonAssocRing/StarRing on the double, chaining over a NonAssocRing base. -/
...
/-! Part-A machinery ported to a `NonAssocRing` base (the cascade's actual base structure
    one rung past associativity). -/
section NA
