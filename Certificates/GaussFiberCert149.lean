/-
  Certificates.GaussFiberCert149 — fiber-h=149 EXCLUSION certificate for
  D = −26063211 (first odd-disc fundamental above X₀(149)).
  149 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −26063211 has size > 149,
  so h(−26063211) ≥ 150 — D is excluded from every fiber ≤ 149.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -26063211) (c₀ := 6515803) (ps := ps) (h := 149)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
