/-
  Certificates.GaussFiberCert140 — fiber-h=140 EXCLUSION certificate for
  D = −22425171 (first odd-disc fundamental above X₀(140)).
  140 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −22425171 has size > 140,
  so h(−22425171) ≥ 141 — D is excluded from every fiber ≤ 140.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -22425171) (c₀ := 5606293) (ps := ps) (h := 140)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
