/-
  Certificates.GaussFiberCert138 — fiber-h=138 EXCLUSION certificate for
  D = −21736707 (first odd-disc fundamental above X₀(138)).
  138 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −21736707 has size > 138,
  so h(−21736707) ≥ 139 — D is excluded from every fiber ≤ 138.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -21736707) (c₀ := 5434177) (ps := ps) (h := 138)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
