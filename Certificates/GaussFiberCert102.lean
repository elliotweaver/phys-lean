/-
  Certificates.GaussFiberCert102 — fiber-h=102 EXCLUSION certificate for
  D = −12197335 (first odd-disc fundamental above X₀(102)).
  102 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −12197335 has size > 102,
  so h(−12197335) ≥ 103 — D is excluded from every fiber ≤ 102.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -12197335) (c₀ := 3049334) (ps := ps) (h := 102)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
