/-
  Certificates.GaussFiberCert104 — fiber-h=104 EXCLUSION certificate for
  D = −12197335 (first odd-disc fundamental above X₀(104)).
  104 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −12197335 has size > 104,
  so h(−12197335) ≥ 105 — D is excluded from every fiber ≤ 104.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -12197335) (c₀ := 3049334) (ps := ps) (h := 104)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
