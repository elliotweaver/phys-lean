/-
  Certificates.GaussFiberCert146 — fiber-h=146 EXCLUSION certificate for
  D = −25357547 (first odd-disc fundamental above X₀(146)).
  146 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −25357547 has size > 146,
  so h(−25357547) ≥ 147 — D is excluded from every fiber ≤ 146.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -25357547) (c₀ := 6339387) (ps := ps) (h := 146)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
