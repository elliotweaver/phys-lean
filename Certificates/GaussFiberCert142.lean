/-
  Certificates.GaussFiberCert142 — fiber-h=142 EXCLUSION certificate for
  D = −22715107 (first odd-disc fundamental above X₀(142)).
  142 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −22715107 has size > 142,
  so h(−22715107) ≥ 143 — D is excluded from every fiber ≤ 142.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -22715107) (c₀ := 5678777) (ps := ps) (h := 142)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
