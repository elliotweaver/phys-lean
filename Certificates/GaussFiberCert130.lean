/-
  Certificates.GaussFiberCert130 — fiber-h=130 EXCLUSION certificate for
  D = −20169771 (first odd-disc fundamental above X₀(130)).
  130 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −20169771 has size > 130,
  so h(−20169771) ≥ 131 — D is excluded from every fiber ≤ 130.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -20169771) (c₀ := 5042443) (ps := ps) (h := 130)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
