/-
  Certificates.GaussFiberCert105 — fiber-h=105 EXCLUSION certificate for
  D = −12197335 (first odd-disc fundamental above X₀(105)).
  105 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −12197335 has size > 105,
  so h(−12197335) ≥ 106 — D is excluded from every fiber ≤ 105.
...
namespace Certificates.FiberCert105
open Phys.Foundation.GaussForms.BQF
open Phys.Foundation

def ps : List Z := [5, 7, 11, 19, 23, 29, 31, 37, 41, 61, 67, 73, 97, 101, 103, 107, 113, 131, 137, 139, 149, 163, 167, 179, 193, 229, 233, 239, 277, 281, 283, 293, 313, 337, 359, 367, 373, 379, 397, 409, 431, 433, 439, 443, 449, 463, 479, 487, 499, 521, 523, 547, 557, 569, 577, 587, 599, 601, 607, 613, 617, 643, 653, 673, 683, 691, 701, 709, 719, 733, 739, 743, 769, 787, 823, 829, 839, 863, 881, 883, 907, 941, 947, 953, 977, 983, 1019, 1063, 1069, 1087, 1091, 1109, 1123, 1129, 1187, 1193, 1201, 1223, 1249, 1277, 1283, 1291, 1297, 1301, 1327]
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -12197335) (c₀ := 3049334) (ps := ps) (h := 105)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
