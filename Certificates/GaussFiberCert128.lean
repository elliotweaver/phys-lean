/-
  Certificates.GaussFiberCert128 — fiber-h=128 EXCLUSION certificate for
  D = −20169771 (first odd-disc fundamental above X₀(128)).
  128 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −20169771 has size > 128,
  so h(−20169771) ≥ 129 — D is excluded from every fiber ≤ 128.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -20169771) (c₀ := 5042443) (ps := ps) (h := 128)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
