/-
  Certificates.GaussFiberCert117 — fiber-h=117 EXCLUSION certificate for
  D = −15942027 (first odd-disc fundamental above X₀(117)).
  117 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −15942027 has size > 117,
  so h(−15942027) ≥ 118 — D is excluded from every fiber ≤ 117.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -15942027) (c₀ := 3985507) (ps := ps) (h := 117)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
