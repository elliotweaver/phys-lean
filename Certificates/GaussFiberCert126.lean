/-
  Certificates.GaussFiberCert126 — fiber-h=126 EXCLUSION certificate for
  D = −19593699 (first odd-disc fundamental above X₀(126)).
  126 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −19593699 has size > 126,
  so h(−19593699) ≥ 127 — D is excluded from every fiber ≤ 126.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -19593699) (c₀ := 4898425) (ps := ps) (h := 126)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
