/-
  Certificates.GaussFiberCert121 — fiber-h=121 EXCLUSION certificate for
  D = −16906227 (first odd-disc fundamental above X₀(121)).
  121 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −16906227 has size > 121,
  so h(−16906227) ≥ 122 — D is excluded from every fiber ≤ 121.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -16906227) (c₀ := 4226557) (ps := ps) (h := 121)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
