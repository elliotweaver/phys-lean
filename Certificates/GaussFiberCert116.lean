/-
  Certificates.GaussFiberCert116 — fiber-h=116 EXCLUSION certificate for
  D = −15483031 (first odd-disc fundamental above X₀(116)).
  116 deep touching primes drive fiber_exclusion (N624):
  any complete duplicate-free box of disc −15483031 has size > 116,
  so h(−15483031) ≥ 117 — D is excluded from every fiber ≤ 116.
...
theorem cert : ∀ (L : List GaussForms.BQF) (pf : GaussForms.BQF),
  ...
  apply fiber_exclusion (D := -15483031) (c₀ := 3870758) (ps := ps) (h := 116)
  · norm_num
  · norm_num
  · exact hpw
  · exact hmem
